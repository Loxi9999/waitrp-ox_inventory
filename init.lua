...
shared = {
    ...
    target = true,--GetConvarInt('inventory:target', 0) == 1,
    police = json.decode(GetConvar('inventory:police', '["police", "sheriff", "doj"]')),
    ...
    server = {
        ...
        dumpsterloot = json.decode(GetConvar('inventory:dumpsterloot', [[
            [
                ["gunpowder", 1, 3, 12],
                ["husk", 1, 5, 8],
                ["weaponpart_barrel", 1, 1, 8],
                ["weaponpart_spring", 1, 1, 8],
                ["lockpick_parts", 1, 1, 12],
                ["burger", 1, 1, 5],
                ["water", 1, 1, 5]
            ]
        ]])),
