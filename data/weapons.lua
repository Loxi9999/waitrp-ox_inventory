return {
	Weapons = {
		...
		['WEAPON_HEAVYRIFLE'] = {
			label = 'Ciężki karabin maszynowy',
			weight = 3300,
			durability = 0.2,
			ammoname = 'ammo-rifle'
		},
		...
		['WEAPON_HEAVYSNIPER'] = {
			label = 'Ciężki karabin snajperski',
			weight = 12700,
			durability = 0.5,
		...
		['WEAPON_SPECIALCARBINE'] = {
			label = 'Specialny karabin maszynowy',
			weight = 3000,
			durability = 0.15,
			ammoname = 'ammo-rifle'
		},
		...
		['WEAPON_SPECIALCARBINE_MK2'] = {
			label = 'Specialny karabin maszynowy MK2',
			weight = 3370,
			durability = 0.03,
			ammoname = 'ammo-rifle'
		},
		...
		['WEAPON_WRENCH'] = {
			label = 'Klucz francuski',
			weight = 2500,
			durability = 0.1,
		},

		['WEAPON_PRECISIONRIFLE'] = {
			label = 'Precyzyjny karabin maszynowy',
			weight = 4800,
			durability = 0.4,
			ammoname = 'ammo-sniper'
		},
		...
		['WEAPON_TACTICALRIFLE'] = {
			label = 'Taktyczny karabin maszynowy',
			weight = 3400,
			durability = 0.03,
			ammoname = 'ammo-rifle'
		},
